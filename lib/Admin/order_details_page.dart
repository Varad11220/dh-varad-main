...
class _OrderDetailsPageState extends State<OrderDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedFoodType = widget.orderData['selectedFoodType'] as String?;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        return selectedFoodType == '1'
                            ? const Text(
                          'Status: 🍴',
                          style: TextStyle(fontSize: 16, color: Colors.orange), // Added color for better visibility
                        )
                            : Text(
            ...
            Center(
              child: selectedFoodType != '1' ? ElevatedButton(
